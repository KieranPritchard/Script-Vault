...
To simplify compliling C++/C code when testing and using. Mainly, because I wanted to streamline this process and have a script to do this ready when coding with these langauges.
